 ...
 */
final class Version20240329090108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, id_user VARCHAR(90) NOT NULL, firstname VARCHAR(55) NOT NULL, email VARCHAR(80) NOT NULL, password VARCHAR(90) NOT NULL, tel VARCHAR(15) DEFAULT NULL, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME NOT NULL, lastname VARCHAR(55) NOT NULL, date_birth DATE NOT NULL, sexe VARCHAR(30) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
